...
@copy "..\..\lib\*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\required\*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\jpa\*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\spring\*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\other\*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\bin\lib\build\*.jar" "bin\lib\build\" >nul 2>nul
@del "src\main\webapp\WEB-INF\lib\servlet-api-2.5-6.1.4.jar" /q
