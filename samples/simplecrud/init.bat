...
@copy "..\..\lib\other\mysql-connector-java-*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\other\commons-dbcp-*.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\other\commons-pool.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
@copy "..\..\lib\other\servlet-api-2.5-6.1.4.jar" "src\main\webapp\WEB-INF\lib\" >nul 2>nul
