 ...
 * @deprecated
 */
public abstract class AbstractPreActionInterceptor implements
		IActionInterceptor {
	...
	public final boolean doBefore(HttpServletRequest request,
			HttpServletResponse response, WebForm form)
			throws InterceptorException {
		// TODO Auto-generated method stub
		return doPreInterception(request, response, form);
	}
