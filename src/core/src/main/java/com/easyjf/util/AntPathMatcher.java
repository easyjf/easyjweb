 ...
 * Some examples:<br>
 * <ul>
 * <li><code>com/t?st.jsp</code> - matches <code>com/test.jsp</code> but
 * also <code>com/tast.jsp</code> or <code>com/txst.jsp</code></li>
...
public class AntPathMatcher {
	 ...
	 * </ul>
	 * <p>
	 * Assumes that {@link #match} returns <code>true</code> for '<code>pattern</code>'
	...
	public boolean match(String pattern, String str) {
		...
		String[] patDirs = StringUtils.tokenizeToStringArray(pattern,
				pathSeparator);
		String[] strDirs = StringUtils
				.tokenizeToStringArray(str, pathSeparator);
